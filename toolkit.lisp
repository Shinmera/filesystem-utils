...
(defun directory-p (file)
  ...
  #+sbcl (eql :directory (sb-impl::native-file-kind (pathname-utils:native-namestring file)))
...
(defun file-p (file)
  ...
  #+sbcl (eql :file (sb-impl::native-file-kind (pathname-utils:native-namestring file)))
