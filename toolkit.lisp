...
(defun directory-p (file)
  ...
  #+cmucl (logtest #o040000 (nth-value 3 (unix:unix-stat (namestring file))))
  #+(or clasp ecl mkcl) (eql :directory (ext:file-kind file NIL))
  #+sbcl (sb-posix:s-isdir (sb-posix:stat-mode (sb-posix:stat file)))
...
(defun file-p (file)
  ...
  #+cmucl (logtest #o0100000 (nth-value 3 (unix:unix-stat (namestring file))))
  #+(or clasp ecl mkcl) (eql :file (ext:file-kind file NIL))
  #+sbcl (logtest sb-posix:s-ifreg (sb-posix:stat-mode (sb-posix:stat file)))
...
(defun symbolic-link-p (file)
  ...
  #+cmucl (logtest #o120000 (nth-value 3 (unix:unix-stat (namestring file))))
  #+(or clasp ecl mkcl) (eql :link (ext:file-kind file NIL))
  #+sbcl (logtest sb-posix:s-iflnk (sb-posix:stat-mode (sb-posix:stat file)))
...
(defun create-symbolic-link (link-file destination-file)
  ...
  #+(and sbcl win32) (let ((src (string->wstring (pathname-utils:native-namestring link-file)))
                       ...
                       (unwind-protect (when (= 0 (sb-alien:alien-funcall (sb-alien:extern-alien "CreateSymbolicLinkW" (function int * * int))
